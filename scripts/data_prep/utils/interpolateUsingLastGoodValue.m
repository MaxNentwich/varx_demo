function [datavector] = interpolateUsingLastGoodValue(DATA, column, validitycolumn, accepted_validities)
...
datavector = DATA{1}(:,column);
validityvector = DATA{1}(:,validitycolumn);
